...
# predictor elimination sorely based on r-squared is not solid.
# grouping computer with singlepar & house does not have a solid reason other than the boxplot
# I got to reject absent through f-test
# fsm sum sq is not 0 
# new_fsmband cannot be rejected if k3ma is treated as a factor
